...
insert into user (username, enabled, password, role_id) values ('user1', true, 'password1', 1);
insert into user (username, enabled, password, role_id) values ('user2', true, 'password2', 1);
